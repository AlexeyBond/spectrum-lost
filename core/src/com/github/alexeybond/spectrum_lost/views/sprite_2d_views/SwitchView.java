...
public class SwitchView extends $Sprite2DView {
    private TextureRegion mgTexture;

    {
        bgTexture = loadTexture("game/cells/switch/bg");
        mgTexture = loadTexture("game/cells/switch/mg");
        fgTexture = loadTexture("game/cells/switch/fg");
    }
